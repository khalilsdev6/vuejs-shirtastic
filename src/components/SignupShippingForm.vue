<template>
  <b-container>
    ...
    <h2>Awesome</h2>
    <p>
      Welcome to the club, where can we ship your shirts to? You can
    ...
    <b-container>
      <b-row>
        <b-col sm="12">
          <BaseInput title="Name">
            <input v-model="name" type="text" placeholder="Johnny Appleseed">
          </BaseInput>
        </b-col>
      </b-row>
      <b-row>
        <b-col>
          <BaseInput title="Address 1">
            <input v-model="address1" type="text" placeholder="123 Anywhere Ave">
          </BaseInput>
        </b-col>
        <b-col>
          <BaseInput title="Address 2">
            <input v-model="address2" type="text" placeholder="Suite 101">
          </BaseInput>
        </b-col>
      </b-row>
      <b-row>
        <b-col>
          <BaseInput title="Phone number">
            <input v-model="phoneNumber" type="text" placeholder="555-123-4567">
          </BaseInput>
        </b-col>
        <b-col>
          <BaseInput title="City">
            <input v-model="city" type="text" placeholder="Toronto">
          </BaseInput>
        </b-col>
      </b-row>
      <b-row>
          ...
          <b-row>
              ...
              <BaseInput title="Province">
                <select v-model="province">
                  ...
                  <option
                    :key="index"
                    v-bind:value="region"
                    v-for="(region, index) of regions[country]"
                  >{{ region }}</option>
                </select>
              </BaseInput>
            </b-col>
            <b-col sm="6">
              <BaseInput title="Postal code">
                <input v-model="postalCode" type="text" placeholder="L5N 2N5">
              </BaseInput>
            </b-col>
          </b-row>
        </b-col>
      ...
      <b-row class="justify-content-between">
        <b-col sm="6">
          <b-button @click="submitLater">Do this later</b-button>
        </b-col>
